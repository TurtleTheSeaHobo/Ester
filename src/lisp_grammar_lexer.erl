...
-module(lisp_grammar_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/lisp_grammar_lexer.xrl", 15).
...
-file("src/lisp_grammar_lexer.erl", 310).
yystate() -> 6.
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 39 ->
    yystate(8, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 42 ->
    yystate(8, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 39 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 58 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 60 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, [41|Ics], Line, Tlen, _, _) ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
...
-file("src/lisp_grammar_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { comment, TokenLine, comment (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/lisp_grammar_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { whitespace, TokenLine, whitespace (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/lisp_grammar_lexer.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
     { token, { open_paren, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/lisp_grammar_lexer.xrl", 10).
yyaction_3(TokenChars, TokenLine) ->
     { token, { close_paren, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/lisp_grammar_lexer.xrl", 11).
yyaction_4(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/lisp_grammar_lexer.xrl", 12).
yyaction_5(TokenChars, TokenLine) ->
